...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Selecciona el elemento de entrada con el id 'buscador2' para filtrar los posts
    ...
    // Añade un evento de entrada (input) al elemento '_input2' para filtrar los posts
