...
<head>
  ...
  <title>MDA Sena - Código de recuperación</title>
</head>
...
<body id="body" class="bg-mdaWhite grid content-center justify-center min-h-screen w-full p-2.5 bg-background3 bg-cover">
  ...
  <section class="container grid bg-white p-7 rounded-lg shadow-md w-full md:w-96 z-10">
    ...
    <form id="form" action="svVerificarCodigoContrasena" class="grid" method="POST">
      <label class="bg-white text-mdaBlack input input-bordered flex items-center gap-2">
        <i class="fa-solid fa-lock text-gray-400"></i>
        <input name="txtCodigo" id="codigo" type="text" class="grow text-mdaBlack" placeholder="Codigo de recuperacion" />
      </label>
  ...
  <!--<script type="module" src="../scripts/codigoRecuperacion.js"></script>-->
</body>
