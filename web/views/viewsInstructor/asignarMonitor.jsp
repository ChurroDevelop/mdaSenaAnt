...
<html lang="en">
  ...
  <body class="flex bg-mdaWhite bg-gradient-to-t from-mdaGreen_400 to-mdaWhite">
    ...
    >
      <article class="bg-white w-full max-w-2xl shadow-md rounded-lg p-5 flex flex-col justify-between gap-5">
        <div class="flex w-full justify-between">
          ...
          <button
            id="closeModal"
            class="btn btn-sm btn-circle btn-ghost text-mdaBlack"
          >
            ✕
          </button>
        </div>
    ...
    >
      <!-- Contenedor -->
      <article
        class="bg-white w-full max-w-2xl shadow-md rounded-lg p-5 flex flex-col justify-between gap-5"
      >
        <!-- Agregar monitor -->
        <div class="flex w-full justify-between">
          ...
          <button
            id="showModal"
            class="btn bg-mdaGreen border-none text-white hover:bg-mdaGreen"
          >
            Agregar monitor
          </button>
        </div>
        ...
        <div class="w-full bg-mdaWhite rounded-lg p-1">
          ...
          <div class="flex justify-between items-center">
            ...
            <form action="">
              <button
                class="btn bg-mdaRed border-none text-white hover:bg-mdaRed"
              >
                Quitar monitor
              </button>
            </form>
