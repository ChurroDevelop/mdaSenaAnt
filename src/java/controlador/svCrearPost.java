...
@MultipartConfig(
        fileSizeThreshold = 1024 * 1024 * 5, // Umbral para almacenar archivos temporalmente en la memoria (5 MB)
...
public class svCrearPost extends HttpServlet {
    ...
    /**
     * Maneja la solicitud HTTP POST para crear un post y cargar archivos asociados.
     *
     * @param request La solicitud HTTP que contiene los parámetros del formulario y archivos.
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Crear un nuevo objeto Post y asignar valores por métodos setters
        Post post = new Post();
        ...
        try {
            ...
            // Redirige a la vista de crear post por parte del monitor
            response.sendRedirect("crearPost.jsp");
            
            // Rompe de una vez la ejecución del servlet
            return;
        }
        ...
        for (Part filePart : fileParts) {
            ...
            if (filePart.getName().equals("archivo") && filePart.getSize() > 0) {
                ...
                // Mensaje de depuración para saber si se tomó o no el archivo
    ...
    private byte[] convertirArrayBite(InputStream inputStream) throws IOException {
        ...
        // Crear un nuevo buffer para almacenar temporalmente los bytes leídos
        ...
        // Bucle para leer byte por byte
        while ((nRead = inputStream.read(data, 0, data.length)) != -1) {
            buffer.write(data, 0, nRead);
        }
        
        // Almacena los datos en memoria y los procesa
        buffer.flush();
